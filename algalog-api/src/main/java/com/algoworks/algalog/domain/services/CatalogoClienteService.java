...
public class CatalogoClienteService {
    ...
    @Transactional // Essa notação fala que esse método deve ser executado dentro dessa transação, ou seja se algo
    // dentro desse método der errado, todas as transações feitas no banco de dados vão dar errado.
